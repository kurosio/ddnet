...
void CGameControllerMod::ProcessRhythmInput(int ClientId, const CNetObj_PlayerInput *pNewInput, int InputTick, int CurrentTick, CNetObj_PlayerInput &PrevInput)
{
	if(!IsValidClientId(ClientId))
		return;
